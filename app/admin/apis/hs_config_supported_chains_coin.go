...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsConfigSupportedChainsCoin}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsConfigSupportedChainsCoin} "{"code": 200, "data": [...]}"
