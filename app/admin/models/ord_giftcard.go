...
type OrdGiftcard struct {
	...
	CardType     string `json:"cardType" gorm:"type:enum('code','physical','horizontal','whiteboard','Debit Receipt','Cash Receipt');comment:卡类型"`
	DiscountRate string `json:"discountRate" gorm:"type:decimal(7,4);comment:折扣汇率，例如0.95表示95折"`
