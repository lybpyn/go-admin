...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsConfigWithdrawFee}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsConfigWithdrawFee} "{"code": 200, "data": [...]}"
