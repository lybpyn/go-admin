...
// @Param lastname query string false "名"
// @Param avatar query string false "头像URL"
// @Param balance query string false "可用余额"
// @Param frozenBalance query string false "冻结余额"
// @Param levelId query string false "用户等级ID"
// @Param experience query string false "当前经验"
// @Param regionId query string false "区域id"
// @Param totalExperience query string false "累计经验"
// @Param inviteCode query string false "邀请码"
// @Param status query string false "状态：1正常，0封禁"
