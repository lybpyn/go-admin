...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsBanks}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsBanks} "{"code": 200, "data": [...]}"
