...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsUserCheckinStats}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsUserCheckinStats} "{"code": 200, "data": [...]}"
