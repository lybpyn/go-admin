...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsReceivingAccounts}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsReceivingAccounts} "{"code": 200, "data": [...]}"
