...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.OrdCurrencyRates}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.OrdCurrencyRates} "{"code": 200, "data": [...]}"
