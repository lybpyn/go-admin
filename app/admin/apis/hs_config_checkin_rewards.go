...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsConfigCheckinRewards}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsConfigCheckinRewards} "{"code": 200, "data": [...]}"
