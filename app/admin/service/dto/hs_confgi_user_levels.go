...
type HsConfgiUserLevelsGetPageReq struct {
    ...
    SortOrder string `form:"sortOrder"  search:"type:exact;column:sort_order;table:hs_confgi_user_levels" comment:"排序顺序"`
    IsActive string `form:"isActive"  search:"type:exact;column:is_active;table:hs_confgi_user_levels" comment:"是否启用"`
