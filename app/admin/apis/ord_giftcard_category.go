...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.OrdGiftcardCategory}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.OrdGiftcardCategory} "{"code": 200, "data": [...]}"
