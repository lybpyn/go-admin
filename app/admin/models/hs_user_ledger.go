...
type HsUserLedger struct {
    ...
    CurrencyCode string `json:"currencyCode" gorm:"type:char(3);comment:ISO 4217，例如 USD/CNY"` 
    ...
    BizType string `json:"bizType" gorm:"type:varchar(32);comment:业务类型：order_settlement/withdraw/withdraw_fee/withdraw_reversal/manual_adjust_*/freeze, unfreeze等"` 
