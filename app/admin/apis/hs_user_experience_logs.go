...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.HsUserExperienceLogs}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.HsUserExperienceLogs} "{"code": 200, "data": [...]}"
