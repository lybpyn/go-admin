...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.OrdGiftcardRegion}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.OrdGiftcardRegion} "{"code": 200, "data": [...]}"
