...
// @Success 200 {object} models.Response{data=models.Page{list=[]models.OrdGiftcard}} "{"code": 200, "data": [...]}"
...
// @Success 200 {object} models.Response{data=models.OrdGiftcard} "{"code": 200, "data": [...]}"
